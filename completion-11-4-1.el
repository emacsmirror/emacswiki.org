...
;;; Change Log
;;;-----------------------------------------------
;;; From version 11.3 to 11.4 (salem and garyo@oberbrunner.com):
...
(defun cmpl-hours-since-1900 (&optional time-string)
  ...
  (let* ((string (or time-string (current-time-string)))
	 ...
	 (day (string-to-number (substring string 8 10)))
	 (year (string-to-number (substring string 22 24)))
	 (hour (string-to-number (substring string 11 13)))
	 )
