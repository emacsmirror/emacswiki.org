;;; folding-2.99.el --- A folding-editor-like minor mode.
...
;; Created:     1992
;; Version:     2.99
;; RCS version: $Revision: 3.9 $
;; Date:        $Date: 2002/02/03 21:09:37 $
;; Keywords:    tools
...
;;
;; X.x   Jul  31  2001  20.7             [2.98-2.99]
...
(defvar folding-version  (substring "$Revision: 3.9 $" 11 15)
...
(folding-add-to-marks-list 'bibtex-mode    "@Comment {{{ " "@Comment }}} */" nil t)
(folding-add-to-marks-list 'bison-mode             "/* {{{ " "/* }}} */" " */" t)
