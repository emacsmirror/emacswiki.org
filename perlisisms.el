;;; this is perlisisms.el
;;; ================================================================
;;; DESCRIPTION:
;;; nmerically indexed alist of `perlisisms'. 
...
;;;
;;; FILE-CREATED:
;;; <Timestamp: #{2009-08-09T18:53:19-04:00Z}#{09327} - by MON KEY>
;;; ================================================================
;;; CODE:

;;; ==============================
;;; REGEXPS to clean html file at ???: 
;;;
;;; (while (search-forward-regexp "^<P>" nil t) (replace-match ""))
;;; (while (search-forward-regexp "  " nil t)  (replace-match " "))
;;; (while (search-forward-regexp "^\\([0-9]\\{1,3\\}\\)\. " nil t) (replace-match "(\\1 \""))
;;; (while (search-forward-regexp "^\\(([0-9]\\{1,3\\}\\ \".*\.$\\)" nil t) (replace-match "\\1\")"))

;;; ==============================
;;; CREATED: <Timestamp: 2009-08-09-W32-7T06:47:46-0400Z - by MON KEY>
(defvar *perlisisms* 'nil
  "Numerically indexed alist of `perlisisms' per his Epigrams in Programming.
SOURCE: Perlis, Alan J., Yale University.
Article: \"Epigrams in Programming\" ACM SIGPLAN publication, \(September, 1982\).")
;;
(when (not (bound-and-true-p *perlisisms*))
           (setq *perlisisms* '(
...
;;;testme; *perlisisms*
;;;testme; (assoc 34 *perlisisms*)
;;;testme; (assoc 60 *perlisisms*)

;;;(progn (makunbound '*perlisisms) (unintern '*perlisisms))
