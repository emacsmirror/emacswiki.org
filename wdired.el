...
;; Copyright (C) 2001 Juan Le�n Lahoz Garc�a

;; Filename: wdired.el
;; Author: Juan Le�n Lahoz Garc�a <juan-leon.lahoz@tecsidel.es>
;; Version: 1.9.2pre3
...
;; From 1.91 to 1.9.2
;;
;; - Ren� Kyllingstad <kyllingstad at users dot sourceforge dot net>
